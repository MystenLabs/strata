...
use core_types::{BlobKey, EncodedRecordParts, PlacementClass, RecordRef, SegmentId, ShardKey};
...
impl SegmentWriter {
    ...
    pub fn append(
        ...
        self.append_for_shard(key, generation, core_types::DEFAULT_RECORD_SHARD, payload)
    }
...
mod tests {
    ...
    use core_types::{BlobKey, PlacementClass};
    use sha2::{Digest, Sha256};
