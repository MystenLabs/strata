//! The store-local half of garbage collection. The pure planner lives in `strata-gc`; this module
...
use strata_gc::{DestinationClass, GcCopyRecord, GcPlan, GcPlanner};
use strata_index::StrataIndex;
use strata_lsm::LiveSnapshots;
