...
//! | lsm_manifests     | String -> strata_lsm::Manifest                 |
//! | garbage_log_positions | String -> strata_lsm::GarbageLogPosition       |
...
//! logical shards. Blob state itself lives in `strata-lsm`; this crate owns only store metadata.
//!
